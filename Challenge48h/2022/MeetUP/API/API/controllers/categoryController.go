...
func GetCategoryById(c *gin.Context) {
	if repository.GetCategoryByName(c.Params.ByName("id")).Id != "" {
...
func PostCategory(c *gin.Context) {
	...
	// if !allowedToEdit {
	// 	c.JSON(http.StatusUnauthorized, gin.H{"err": "You are not allowed to create a new category"})
	// 	return
	// }
	...
	if repository.GetCategoryByName(input.Name).Id != "" {
...
func PutCategoryById(c *gin.Context) {
	...
	// if !allowedToEdit {
	// 	c.JSON(http.StatusUnauthorized, gin.H{"err": "You are not allowed to edit this category"})
	// 	return
	// }
...
func DeleteCategoryById(c *gin.Context) {
	...
	// if !allowedToEdit {
	// 	c.JSON(http.StatusUnauthorized, gin.H{"err": "You are not allowed to delete this category"})
	// 	return
	// }

	if repository.GetCategoryById(c.Params.ByName("id")).Name == "" {
