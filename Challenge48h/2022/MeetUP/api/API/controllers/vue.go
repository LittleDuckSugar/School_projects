...
func ShowIndexPage(c *gin.Context) {
	resp, err := http.Get("http://localhost:80/api/")
	if err != nil {
		ShowErrorPage(c, 404)
	} else {
...
func ShowRegisterUserPage(c *gin.Context) {
	...
	if err == nil {
		...
		resp, err = http.Post("http://localhost:80/api/user", "application/json", bytes.NewBuffer(data))
		if err != nil {
			log.Fatalln(err)
		}
		defer resp.Body.Close()
...
func ShowRegisterOrgaPage(c *gin.Context) {
	...
	if "" != c.PostForm("username") && "" != c.PostForm("email") && "" != c.PostForm("tel") && "" != c.PostForm("password") {
		...
		resp, err = http.Post("http://localhost:80/api/orga", "application/json", bytes.NewBuffer(data))
		if err != nil {
			log.Fatalln(err)
		}
		defer resp.Body.Close()
...
func ShowEventPage(c *gin.Context) {
	...
	resp, err := http.Get("http://localhost:80/api/event/" + c.Param("id"))
	if err != nil {
		log.Fatal(err)
	}
	defer resp.Body.Close()
...
func ShowProfilPage(c *gin.Context) {
	...
	resp, err := http.Get("http://localhost:80/api/user/" + id)
	if err != nil {
		log.Fatalln(err)
	}
...
func ShowAllUserPage(c *gin.Context) {
	resp, err := http.Get("http://localhost:80/api/users")
	if err != nil {
		log.Fatalln(err)
	}
...
func ShowAllOrgasPage(c *gin.Context) {
	resp, err := http.Get("http://localhost:80/api/orgas")
	if err != nil {
		log.Fatalln(err)
	}
...
func ShowAllAdminPage(c *gin.Context) {
	resp, err := http.Get("http://localhost:80/api/admins")
	if err != nil {
		log.Fatalln(err)
	}
...
func ShowOrgaPage(c *gin.Context) {
	...
	resp, err := http.Get("http://localhost:80/api/orga/" + id)
	if err != nil {
		log.Fatalln(err)
	}
...
func ShowCreateEventPage(c *gin.Context) {
	...
	if c.PostForm("name") != "" {
		...
		resp, err := http.Post("http://localhost:80/api/event", "application/json", bytes.NewBuffer(data))
		if err != nil {
			log.Fatalln(err)
		}
		defer resp.Body.Close()
